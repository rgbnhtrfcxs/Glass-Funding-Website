-- Migration: normalize labs.org_role labels to consistent spacing/casing
...
begin
  if to_regclass('public.labs') is not null then
    ...
    -- If legacy values are only present in lab_profile.org_role, backfill first.
