...
const ACTIVE_AUDIT_BOOKING_STATUSES = ["pending", "confirmed"] as const;

const formatAuditSlotLabel = (slot: {
...
const buildAuditCalendarPackage = (input: {
  bookingId: number;
  labName: string;
...
const sendAuditBookingUserMail = async (input: {
