        ...
        <div className="bg-card border border-border rounded-3xl shadow-sm p-8 lg:p-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-10">
            <div className="rounded-2xl border border-border bg-muted/20 p-6">
              ...
              <p className="mt-2 text-3xl font-semibold">{overview.totalInvested}</p>
              <span className="inline-flex items-center gap-2 text-xs text-emerald-500 mt-3">
                {overview.activePositionsLabel}
              </span>
            </div>
            <div className="rounded-2xl border border-border bg-muted/20 p-6">
            ...
            <div className="space-y-6">
              ...
              <div className="rounded-2xl border border-border bg-primary/10 p-6">
                ...
                <p className="text-sm text-primary/80 mt-2">
                  Stay informed about breaking research milestones, new funds, and investor briefings.
                </p>
